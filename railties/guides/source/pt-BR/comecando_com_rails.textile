...
|+test/+		|Testes unitários, fixtures, e outros aparatos de teste. Estes são tratados em "Testando Aplicações Rails":testando_aplicacoes_rails.html.|
...
h5. Configurando um Bando de Dados MySQL
...
h5. Configurando um Bando de Dados PostgreSQL
...
!images/rails_welcome.png(Welcome Abord screenshot)!
...
NOTA: Para mais informações sobre rotas, ver em "Roteamento Rails de Fora para Dentro":roteamento_rails_de_fora_para_dentro.html.

h3. Iniciando e Executando Rapidamente com o Scaffolding
