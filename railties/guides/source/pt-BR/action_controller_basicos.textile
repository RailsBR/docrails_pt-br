...
NOTE: Para mais detalhes sobre o processamento de rotas, veja o "Roteamento Rails de Fora para Dentro":roteamento_rails_de_fora_para_dentro.html 
...
Leia mais sobre armazenamento de sessão no Guia de "Seguranca":seguranca.html.
