...
Se você encontrar um relatório de bug sem um teste, é muito útil contribuir com um teste de falha. Isto é também um grande modo de começar a explorar o código do Rails: olhando os arquivos de testes existentes irá ensinar-lhe como escrever mais testes para o Rails. Novos testes são melhor contribuídos na forma de um patch, como explicado posteriormente na seção "Contribuinte para o Código do Rails"
...
* March 24, 2009: Tradução para português por "Carlos A. da Silva":translators.html#carlosantoniodasilva
* March 2, 2009: Rascunho inicial por "Mike Gunderloy":credits.html#mgunderloy
