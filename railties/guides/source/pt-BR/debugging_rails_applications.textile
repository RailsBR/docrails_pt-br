...
No caso do você precisar baixar uma versão diferente ou o código fonte, você pode acessar "a página do projeto no rubyforge":http://rubyforge.org/projects/ruby-debug/.
