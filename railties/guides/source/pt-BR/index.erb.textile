...
* "Versão Atual (baseado no Rails 2.2)":http://guides.rubyonrails.org/
* "Versão para o Edge Rails (baseado no branch do Rails 2.3)":http://guides.rails.info
...
<dl>
<% guide('Começando com Rails', 'comecando_com_rails.html') do %>
...
<% guide("Associações do Active Record", 'associacoes_basicas.html') do %>
...
<% guide("Depurando Aplicações Rails", 'depurando_aplicacoes_rails.html') do %>
...
<% guide("Benchmarking e Profiling em Aplicações Rails", 'performance_testing.html') do %>
