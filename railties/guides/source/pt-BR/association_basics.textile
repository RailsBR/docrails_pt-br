...
Passando +true+ para a opção +:polymorphic+ indica que esta será uma associação polimórfica. Associações polimórficas foram discutidas em detalhes "anteriormente neste guia":#associaespolimrficas.
...
Definindo a opção +:as+ indica que esta será uma associação polimórfica. Associações polimórficas foram discutidas em detalhes "anteriormente neste guia":#associaespolimrficas.
...
A opção +:through+ específica um model para a junção para executar a query. "Associações +has_one :through+ já foram discutidas em detalhes":#aassociaohas-onethrough.
...
Definindo a opção +:as+ indica que essa será uma associação polimórfica. Associações polimórficas foram discutidas em detalhes "anteriormente neste guia":#associaespolimrficas.
...
A opção +:extend+ especifica o nome de um módulo para extender o proxy de associação. Extensão de associações "serão discutidas com mais detalhes neste guia":#extensesdeassociao.
...
Por convenção, o Rails descobre que a coluna que armazenará a chave primária deste model é +id+. Você pode sobrescrever isso e especificar a chave primária com a opção +:primary_key+.
...
A opção +:extend+ especifica um módulo para estender o proxy de associação. Extensão de associações "serão discutidas com mais detalhes neste guia":#extensesdeassociao.
