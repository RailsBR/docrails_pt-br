...
Quando aninhar através de uma relação +has_one+ você precisará criar um novo objeto em branco para o objeto aninhado antes de chamar o +fields_for+ na view.

Um método +build_&lt;model_name&gt;+ foi criado para este propósito:
...
Caso contrário +@customer.order+ retornará +nil+ e seu formulário irá falhar. As relações +has_many+ não precisam deste passo extra.
