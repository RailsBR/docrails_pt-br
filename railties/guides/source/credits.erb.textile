...
<% author('Cairo Noleto', 'caironoleto') do %>
  Cairo Noleto is a Brazilian software developer working with different programming languages such as Ruby, Python, PHP and ASP. He blogs at "Cairo'sBlog":http://caironoleto.com, which is mainly written in Portuguese and has an active "twitter account":http://twitter.com/caironoleto.
<% end %>
